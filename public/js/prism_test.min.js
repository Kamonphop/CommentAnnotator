/* http://prismjs.com/download.html?themes=prism-okaidia&languages=markup+css+clike+javascript+c+cpp+java&plugins=line-highlight+line-numbers */
var counter = 0;
var _self = "undefined" != typeof window ? window : "undefined" != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope ? self : {},
    Prism = function() {
        ...
        if (a.stringify = function(e, t, r) {
                ...
                if(i.type == "comment"){
                	counter+=1;
                	return "<" + i.tag + ' class="' + i.classes.join(" ") + '"' + (o ? " " + o : "") + " id='comment_"+counter+"'>" + i.content + "</" + i.tag + ">";
                }else{
    ...
    "undefined" != typeof self && self.Prism && self.document && Prism.hooks.add("complete", function(e) {
        if (e.code) {
            ...
            if (t && /pre/i.test(t.nodeName) && (s.test(t.className) || s.test(e.element.className)) && !e.element.querySelector(".line-numbers-rows")) {
                ...
                n.innerHTML = r, 
                t.hasAttribute("data-start") && (t.style.counterReset = "linenumber " + (parseInt(t.getAttribute("data-start"), 10) - 1)), e.element.appendChild(n)
            }
        }
    })
}();
! function() {
    ...
    function n(e, n, i) {
        for (var o, a = n.replace(/\s+/g, "").split(","), d = +e.getAttribute("data-line-offset") || 0, l = r() ? parseInt : parseFloat, c = l(getComputedStyle(e).lineHeight), s = 0; o = a[s++];) {
            ...
            h.textContent = Array(m - u + 2).join(" \n"), h.setAttribute("aria-hidden", "true"), h.className = (i || "") + " line-highlight", (h.setAttribute("data-start", u), m > u && h.setAttribute("data-end", m)), h.style.top = (u - d - 1) * c + "px", t(e, "line-numbers") ? e.appendChild(h) : (e.querySelector("code") || e).appendChild(h)
        }
    }
